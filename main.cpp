...
struct Task {
    ...
    bool isDone = false; //Status Tugas
};
...
void tandaiTugasSelesai() {
    ...
    if (index >= 1 && index <= (int)toDoList.size()) {
        ...
        cout << "Tugas ditandai sebagai selesai.\n";
    } else {
        cout << "Nomor tidak valid.\n";
    }
}

void tampilkanTugasSelesai() {
    cout << "\n=== Tugas yang Sudah Selesai ===\n";
    bool ada = false;
    for (const auto &task : toDoList) {
        if (task.isDone) {
            cout << "- " << task.title << " | Deadline: " << task.deadline 
                 << " | Prioritas: " << task.priority << "\n";
            ada = true;
        }
    }
    if (!ada) {
        cout << "Belum ada tugas yang selesai.\n";
    }
}
...
int main() {
    ...
    do {
        ...
        cout << "5. Tandai Tugas Selesai\n";
        cout << "6. Tampilkan Tugas Selesai\n";
        cout << "7. Keluar\n";
        cout << "Pilih menu: ";
        cin >> pilihan;
        ...
        switch (pilihan) {
            ...
            case 5: tandaiTugasSelesai(); break;
            case 6: tampilkanTugasSelesai(); break;
